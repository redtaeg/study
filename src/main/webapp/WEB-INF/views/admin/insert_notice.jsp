  ...
  <body>
    ...
    <div class="container">
     ...
     <div class="py-5 text-center">
         ...
         <form method="post" action ="/admin/insert_notice_conFirm">
	    <div class="row justify-content-center col-12">
		   <div class="mb-3"  style="width: 800px;">
		     <label for="ez_notice_title" class="form-label">제목</label>
		     <input type="text" class="form-control" id="ez_notice_title" name = "ez_notice_title" >
		   </div>
		   
		  <div class="mb-3"  style="width: 800px;">
		     <label for="ez_notice_content" class="form-label">내용</label>
		     <textarea class="form-control" id="ez_notice_content" name="ez_notice_content" rows="3" cols="50" wrap=on style="height: 500px;"></textarea>
		   </div>
	    </div>
	    
	<div class="row justify-content-center col-12">
	    <div class="col-6 text-end">
	        <button class="w-50 btn btn-primary btn-lg" type="submit">등록하기</button>
	    </div>
