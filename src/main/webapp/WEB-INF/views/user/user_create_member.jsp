		...
		<main>
			...
			<div class="row justify-content-center g-5">
				<div class="col-md-7 col-lg-8">
					...
					<form method="post" action="/user/user_confirm_member"
					    name="user_create_form" class="needs-validation" novalidate
					    onsubmit="return validateForm();">
						<div class="row g-3">
							<div class="col-12">
								<label for="ez_user_name" class="form-label">이름</label>
								<div class="input-group has-validation">
									<input type="text" class="form-control" id="ez_user_name"
										placeholder="이름" required name="ez_user_name">
							...
							<div class="col-12">
								...
								<div class="input-group has-validation">
									<input type="text" class="form-control" id="ez_user_age"
										placeholder="나이" required name="ez_user_age">
							...
							<div class="col-12">
								...
								<div class="form-check">
									<input class="form-check-input" type="radio" id="flexRadioMale"
										name="ez_user_gender" value="남자" checked> <label
										class="form-check-label" for="flexRadioMale"> 남자 </label>
								</div>
								<div class="form-check">
									<input class="form-check-input" type="radio"
										id="flexRadioFemale" name="ez_user_gender" value="여자">
							...
							<div class="col-12">
								...
								<div class="input-group has-validation">
									<input type="text" class="form-control" id="ez_user_weight"
										placeholder="체중" required name="ez_user_weight">
									<div class="invalid-feedback">체중을 입력하지 않았습니다</div>
								</div>
							</div>
							...
							<div class="col-12">
								...
								<div class="input-group has-validation">
									<input type="text" class="form-control" id="ez_user_id"
										placeholder="아이디" required name="ez_user_id">
						...
						<div class="col-12">
							...
							<div class="input-group has-validation">
								<input type="password" class="form-control" id="ez_user_pw"
									placeholder="비밀번호" required name="ez_user_pw">
						...
						<div class="col-12">
							...
							<div class="input-group has-validation">
								<input type="password" class="form-control" id="ez_user_pw2"
								placeholder="비밀번호 재입력" required name="ez_user_pw2">
						...
						<div class="col-12">
							...
							<div class="input-group has-validation">
								<input type="text" class="form-control" id="ez_user_phone"
									placeholder="휴대폰 번호" required name="ez_user_phone">
								<div class="invalid-feedback">핸드폰번호를 입력하지 않았습니다</div>
							</div>
						</div>

						<div class="col-12">
							<label for="ez_user_mail" class="form-label">이메일</label>
							<div class="input-group has-validation">

								<input type="email" class="form-control" id="ez_user_mail"
									placeholder="이메일 주소" required name="ez_user_mail">
								<div class="invalid-feedback">EMAIL을 입력하지 않았습니다</div>
							</div>
						</div>
							...
							<div class="input-group has-validation">
								<div class="form-check form-switch">
									<input class="form-check-input" type="checkbox" role="switch"
										id="upper" name="ez_user_keyword" value="상체" checked> <label
										class="form-check-label" for="upper">상체 </label>
								</div>
								<div class="form-check form-switch">
									<input class="form-check-input" type="checkbox" role="switch"
										id="arm" name="ez_user_keyword" value="팔"> <label
										class="form-check-label" for="arm">팔 </label>
								</div>
								<div class="form-check form-switch">
									<input class="form-check-input" type="checkbox" role="switch"
										id="belly" name="ez_user_keyword" value="복부"> <label
										class="form-check-label" for="belly">복부 </label>
								</div>
								<div class="form-check form-switch">
									<input class="form-check-input" type="checkbox" role="switch"
										id="lower" name="ez_user_keyword" value="하체"> <label
										class="form-check-label" for="lower">하체 </label>
								</div>
								<div class="form-check form-switch">
									<input class="form-check-input" type="checkbox" role="switch"
										id="cardio" name="ez_user_keyword" value="유산소"> <label
										class="form-check-label" for="cardio">유산소 </label>
								</div>
								<div class="form-check form-switch">
									<input class="form-check-input" type="checkbox" role="switch"
										id="diet" name="ez_user_keyword" value="다이어트"> <label
										class="form-check-label" for="diet">다이어트 </label>
								</div>
								<div class="form-check form-switch">
									<input class="form-check-input" type="checkbox" role="switch"
										id="stretching" name="ez_user_keyword" value="스트레칭"> <label
										class="form-check-label" for="stretching">스트레칭 </label>
								</div>
			...
			<div class="row justify-content-center">
				<div class="col-md-6">
					<button class="w-100 btn btn-primary btn-lg" type="submit">사용자로
						회원가입하기</button>
			   </div>	
			</div>
			 </form>
							...
							function validateForm() {
								...
								let form = document.user_create_form;
								let password = form.ez_user_pw.value;
								let confirmPassword = form.ez_user_pw2.value;

								// 비밀번호 일치 여부 검사
								if (password !== confirmPassword) {
									document.getElementById('pw_match_error').style.display = 'block';
									form.ez_user_pw2.focus();
									return false;
								} else {
									document.getElementById('pw_match_error').style.display = 'none';
								}
