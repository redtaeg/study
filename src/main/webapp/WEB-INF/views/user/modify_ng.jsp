...
<table>
    ...
    <tr>
      <td style="width: 170px;">
        <a href=""><button class="w-100 btn btn-primary btn-lg" type="submit">정보수정</button></a>
      </td>
      <td style="width: 170px;">
        <a href=""><button class="w-100 btn btn-primary btn-lg" type="submit">회원 탈퇴</button></a>
      </td>
      <td style="width: 170px;">
        <a href=""><button class="w-100 btn btn-primary btn-lg" type="submit">즐겨찾기</button></a>
      </td>
      <td style="width: 170px;">
        <a href=""><button class="w-100 btn btn-primary btn-lg" type="submit">상담내역</button></a>
      </td>
    </tr>
  </thead>
</table>
