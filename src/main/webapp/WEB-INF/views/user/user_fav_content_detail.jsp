...
<title>운동 EASY - 사용자 영상 즐겨찾기영상 상세보기</title>
  ...
  ================================================== -->
		...
		<div class="container marketing">
			...
			<div class="row featurette">
				<div class="col-md-7">
					<h2 class="featurette-heading fw-normal lh-1">${contentsDo.ez_con_title}</h2>
					<p class="lead">${contentsDo.ez_con_keyword}</p>
					<p class="lead">정보 : ${contentsDo.ez_con_info}</p>
					<p class="lead">레벨 : ${contentsDo.ez_con_level}</p>
					<p class="lead">등록일 : ${contentsDo.ez_con_reg_date}</p>
					<%-- <c:url value='/user/user_fav_con_confirm' var='addFavTr_url'>
						<c:param name='ez_tr_user_id' value='${contentsDo.ez_tr_user_id}' />
					</c:url>
					<p>
						<a class="btn btn-secondary" href="${addFavTr_url}">트레이너
							즐겨찾기추가&raquo;</a>
					</p> --%>
				</div>
				<div class="col-md-5">
					...
					<video controls>
						<source
							src="<c:url value='/libraryUploadImg/${contentsDo.ez_con_video}'/>"
							type="video/mp4">
