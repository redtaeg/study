...
<title>운동 EASY - 사용자 즐겨찾기 트레이너</title>
...
<body>
		...
		<section class="py-5 text-center container">
			<div class="row py-lg-5">
				<div class="col-lg-6 col-md-8 mx-auto">
					<h1 class="fw-bold">즐겨찾기한 트레이너 목록입니다</h1>
					<p class="lead text-body-secondary">클릭해서 정보를 확인해보세요</p>
					<p>	</p>
				</div>
			</div>
		</section>
  ...
  ================================================== -->
		...
		<div class="album py-5 bg-body-tertiary">
			...
			<c:if test="${favTrDos == null}">
				<section class="py-5 text-center container">
					<div class="row py-lg-5">
						<div class="col-lg-6 col-md-8 mx-auto">
							<h1 class="fw-bold">즐겨찾기한 트레이너가 없습니다!</h1>
						</div>
					</div>
				</section>
			</c:if>
			<div class="row">
				<c:forEach var="favTrlist" items="${favTrDos}">
				<div class="col-lg-4">
<!-- 					<svg class="bd-placeholder-img rounded-circle" width="140"
						...
						<title>Placeholder</title><rect width="100%" height="100%"
							...
							<c:url value="/images/${favTrlist.ez_tr_user_photo}"  var = "profile"/>
								 <img src = "${profile}" width="40%" height="40%" fill="var(--bs-secondary-color)" />
				    <h4 class="fw-bold">${favTrlist.ez_tr_user_name}</h4>
					<p>나이 : ${favTrlist.ez_tr_user_age}</p>
					<p>지역 : ${favTrlist.ez_tr_user_region}</p>
					<c:url value='/tr/tr_list_info' var='detail_url'>
						<c:param name="ez_tr_user_id" value='${favTrlist.ez_tr_user_id}'>
						</c:param>
					</c:url>
					<p>
						<a class="btn btn-secondary" href="${detail_url}">트레이너
							상세보기&raquo;</a>
					</p>
				</div>
				</c:forEach>
