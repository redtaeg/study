	...
	<main>
			...
			<div class="row py-lg-5">
				<div class="col-lg-6 col-md-8 mx-auto">
					<h1 class="fw-bold">상담신청요청 리스트입니다</h1>
					<p class="lead text-body-secondary">사용자와 연락후 상담날짜를 계획하세요</p>
					<p>	</p>
				</div>
			</div>
		</section>
...
<!-- 		<div id="myCarousel" class="carousel slide mb-6"
	...
	<div class="container markerting" style="min-height:700px">
      ...
      <tbody class="table-group-divider">
        	...
        	<tr>
	          <td>${apply.ez_apply_user_name}</td>
	          <td>${apply.ez_apply_phone}</td>
 			  ...
 			  <td>
				<c:choose>
					<c:when test="${apply.ez_apply_result eq 0}">
						<c:url value='/apply/apply_cancleApplyTr' var='cancleApplyTr_url'>
							<c:param name='applyNo' value='${apply.ez_apply_no}'/>
						</c:url>
						
						<c:url value='/apply/apply_approvalApplyTr' var='approvalAppl_url'>
							<c:param name='applyNo' value='${apply.ez_apply_no}'/>
						</c:url>
						<a href="${approvalAppl_url}" class="btn btn-success">완료</a>
						<a href="${cancleApplyTr_url}" class="btn btn-danger">취소</a>
					</c:when>
					...
					<c:otherwise>
						<a class="btn btn-secondary">상담취소</a>
					</c:otherwise>
